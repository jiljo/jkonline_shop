                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" id="add_product">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Amount <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="amount" name="amount" placeholder="Product Amount." required="">
                                            </div>
                                        </div>
