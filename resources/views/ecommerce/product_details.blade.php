            ...
            <div class="row g-4">
                <div class="col-lg-5 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="featured-product mb-4">
                        ...
                        <div class="featured-product-item">
                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                <img src="{{ asset('uploads/' . $product['product_image_path']) }}" class="img-fluid rounded" alt="Image">
                            </div>
                            <div>
                                <h6 class="mb-2">Smart Camera</h6>
                                <div class="d-flex mb-2">
                    ...
                    <div class="row g-4 single-product">
                        <div class="col-xl-6">
                            <div class="single-carousel owl-carousel">
                            	@php
    $photos = explode(',', $product['more_photos']);
@endphp

@foreach ($photos as $photo)
    <div class="single-item"
        data-dot="<img class='img-fluid' src='{{ asset('uploads/' . trim($photo)) }}' alt=''>">
        <div class="single-inner bg-light rounded">
            <img src="{{ asset('uploads/' . trim($photo)) }}" class="img-fluid rounded" alt="Image">
        </div>
    </div>
@endforeach
                        ...
                        <div class="col-xl-6">
                            ...
                            <h5 class="fw-bold mb-3">${{ $product['offer_amount']; }}</h5>
                            ...
                            <div class="input-group quantity mb-5" style="width: 100px;">
                                ...
                                <input type="text" class="form-control form-control-sm text-center border-0 order_quantity" value="1">
                                <div class="input-group-btn">
    ...
    <script src="{{ asset('ecommerce/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('ecommerce/lib/counterup/counterup.min.js') }}"></script>
    <script src="{{ asset('ecommerce/lib/owlcarousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('ecommerce/lib/lightbox/js/lightbox.min.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $('#add_to_cart').click(function(e)
        {
          ...
          var ordered_item_count = $('.order_quantity').val();
         var csrfToken = $('meta[name="csrf-token"]').attr('content');
           $.ajax({
                url: '/save-order',          // Laravel route URL
                type: 'POST',
                data: {
                      pid: "{{ $product['pid'] }}",
                    _token: csrfToken,       // important for Laravel
                    quantity: ordered_item_count
                },
